        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="{{ url('home') }}"><img style="height: 40px;" src="admin/assets/compiled/svg/hafara.svg"
                                alt="Logo" srcset=""></a>
                    </div>
                ...
                <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ url('view_room') }}" class="submenu-link">View Rooms</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="{{ url('view_roomType') }}" class="submenu-link">View Room Types</a>
                    ...
                    @if (Auth::user()->role == 'owner')
                        <li class="{{ Request::is('owner') ? 'active' : '' }}">
                            <a href="{{ url('owner') }}" class='sidebar-link'>
                                <i class="bi bi-person"></i>
                                <span>Owner</span>
                            </a>
                        </li>
